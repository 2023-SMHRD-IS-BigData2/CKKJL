			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-6 mb-4">
							<h1 class="h3 mb-4 text-gray-800">매치용병 등록하기</h1>
										...
										<section>
											<form>
												...
												<br> <label for="playerName">팀 이름</label> <input
													...
													required> <br> <label for="position"><br>시작
													시간</label> <select id="matching_starttime" name="starttime"
													required>
