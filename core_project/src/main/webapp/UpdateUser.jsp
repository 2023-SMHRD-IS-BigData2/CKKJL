...
<body id="page-top">
               ...
               <nav
                  ...
                  <a class="nav-link collapsed" href="RealMyPage.jsp"
                     ...
                     aria-controls="collapseTwo"> <span><button
                           ...
                           style="margin-right: 10px;">My Page</button></span>
                  </a> <a class="nav-link collapsed" href="RealFeedWrite.jsp"
                     data-target="#collapseTwo" aria-expanded="true"
                     aria-controls="collapseTwo"> <span><button
                           class="button is-primary is-outlined is-large"
                           style="margin-right: 10px;">피드 작성</button></span>
                  </a> <a class="nav-link collapsed" href="RealPagenation.jsp"
                     data-target="#collapseTwo" aria-expanded="true"
                     aria-controls="collapseTwo"> <span><button
                           class="button is-primary is-outlined is-large"
                           style="margin-right: 10px;">매칭용병 등록</button></span>
                  </a> <a class="nav-link collapsed" href="ViewPagenation.jsp"
                     data-target="#collapseTwo" aria-expanded="true"
                     aria-controls="collapseTwo"> <span><button
                           class="button is-primary is-outlined is-large"
                           style="margin-right: 10px;">매칭용병 보기</button></span>
                  </a>
                  <!-- Topbar Navbar -->
                  <ul class="navbar-nav ml-auto">
 ...
 %> <span class="mr-2 d-none d-lg-inline text-gray-600 small"><%=vo.getNick()%></span>
                        ...
                        <div
                           ...
                           </a> <a class="dropdown-item" href="./updateuser.jsp"> <i
