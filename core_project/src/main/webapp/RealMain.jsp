											...
											<div class="container-fluid">
												<div class="table-responsive">
													<table class="table table-bordered" id="dataTable"
														style="width: 700px;" cellspacing="0">
														<thead>
															<tr>
														...
														<tbody>
															<tr>
																<td rowspan="2"><img alt=""
																	src="img/<%=i.getFeed_file()%>" width="300"
																	height="300" object-fit: cover><br>
																	...
																	<div class="comment-form">
																		<form id="commentForm" action="CommentService">
																			<input type="hidden" name="F_INDEX"
																				...
																				value="<%=vo.getNick()%>"> <label
																				for="comment">댓글 입력:</label>
																			<textarea id="comment" name="C_COMMENT" rows="4"
