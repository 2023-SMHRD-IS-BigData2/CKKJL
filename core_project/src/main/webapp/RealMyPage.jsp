                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item"><a class="nav-link collapsed" href=<%if (vo != null) {%> "RealMyPage.jsp" <%} else {%>"RealLogin.jsp"<%}%>
								...
								<li class="nav-item"><a class="nav-link collapsed"
									href=<%if (vo != null) {%> "RealFeedWrite.jsp" <%} else {%> "RealLogin.jsp" <%}%>
									data-target="#collapseTwo" aria-expanded="true"
									aria-controls="collapseTwo"> <span align="center"><button
								...
								<li class="nav-item"><a class="nav-link collapsed"
									href=<%if (vo != null) {%> "RealPagenation.jsp" <%} else {%>"RealLogin.jsp" <%}%>
									data-target="#collapseTwo" aria-expanded="true"
									aria-controls="collapseTwo"> <span align="center"><button
								...
								<div
									...
									%> <div class="friend-request" align="center">
                                        ...
                                        <div class="friend-actions">
                                            ...
                                            </a> <a href="FriendService3?id3=<%=friends.get(i).getApplicant()%>">
                            ...
                            <div>
                                <form action="DeleteService" method="post">
                                    ...
                                    <div style="margin-left: 10px">
                                        <input type="submit" value="삭제" style="background-color: #5fa92d; border-color: #5fa92d; border-radius: 10px; color: white; font-weight: bold">
                                    </div>
                                </form>
                            </div> <%
 }
 ...
 %></a> <!-- Dropdown - User Information -->
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        ...
                        <%
									...
									%>
                        <a class="dropdown-item" href="UpdateUser.jsp"> <i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> 정보변경 <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal"> <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                                로그아웃
                            </a> <%
 }
 %>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <h3 class="m-0 font-weight-bold text-primary">My
                                        Profile</h3>
                                    <h5><%=vo.getIntro()%></h5>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table" align="center">
                                <tr>
                                    <th colspan="2" style="background-color: gray;">
                                        <font color="white">피드백
                                    </th>
                                </tr>
                                <%
											List<Matching> match1 = new MatchingDAO().feedbackMatching(vo.getU_id());
											if (match1 != null) {
												for (int m = 0; m < match1.size(); m++) {
													Member challenger = new MemberDAO().login(match1.get(m).getChallenger());
											%>
                                <tr>
                                    <td><a href="FeedbackWrite.jsp?target=<%=match1.get(m).getChallenger()%>&index=<%=match1.get(m).getF_index() %>" style="color:#858796" id="feedbackLink<%=m%>" onclick="changeColor(<%=m%>)">
                                ...
                                <%
											...
											%>
                                <%
											List<Matching> match2 = new MatchingDAO().feedbackMatching2(vo.getU_id());
											if (match2 != null) {
                                ...
                                <script>
                                    function changeColor(index) {
                                        var linkId = 'feedbackLink' + index;
                                        document.getElementById(linkId).style.color = 'purple'; // Change to the desired color
                                    }
                                </script>
                            </table>
