							...
							<div class="col-md-10" style="max-width: 800px;">
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<div class="row align-items-center">
											<div class="col-auto d-flex">
												...
												if (vo.getPic().contains("http")) {
												%>
												<img class="rounded-circle mr-3" src="<%=vo.getPic()%>"
													alt="프로필 사진" width="120" height="120">
												<%
												} else {
												%>
												<img class="rounded-circle mr-3" src="img/<%=vo.getPic()%>"
													alt="프로필 사진" width="120" height="120">
												<%
												}
												%>
									...
									<div class="card-body">
										...
										<table class="table">
											<tr>
												<th style="background-color: gray;"><font color="white">친구
														목록</th>
											</tr>
											<%
										...
										<table class="table" align="center">
											<tr>
												<th colspan="2" style="background-color: gray;"><font
													color="white">팀 평가</th>
											</tr>
											<tr>
										...
										<table class="table" align="center">
											...
											%>
											<tr>
												<td><a href="FeedbackWrite.jsp?target=<%=match1.get(m).getChallenger()%>">													
											...
											if (match2 != null) {
												...
												<tr>
                                                    <td><a href="FeedbackWrite.jsp?target=<%=match2.get(m).getWriter()%>">
