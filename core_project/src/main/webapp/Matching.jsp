...
<body>
   ...
   <header>
      <a href="Main.jsp"> <img src="핵심images/FUTSAL062-removebg-preview.PNG" alt="" /></a>
      <h1>매치 용병 등록하기</h1>
   </header>
   <main>
      <section>
         ...
         <form>
            ...
            <label for="playerName">팀 이름</label> <input type="text" id="matching_playerName" name="playerName"
               required> <label for="position">시작 시간</label> <select id="matching_starttime" name="starttime"
               required>
            ...
            </select> <label for="position"> 끝나는 시간</label> <select id="matching_finishtime" name="finishtime">
               <option value="미정">미정</option>
               <option value="00:00">00:00</option>
               <option value="01:00">01:00</option>
               <option value="02:00">02:00</option>
            ...
            </select> <label for="position"> 인원수 </label> <select id="matching_peoplenum" name="peoplenum">
               <option value="5vs5">5:5</option>
               <option value="6vs6">6:6</option>
               <option value="7vs7">7:7</option>
               <option value="그 외">그 외</option>
            </select> <label for="position">수준</label> <select id="matching_level" name="matching_level">
               <option value="하">하</option>
               <option value="하상">하상</option>
               <option value="중하">중하</option>
               <option value="중상">중상</option>
               <option value="상">상</option>
            </select> <label for="position"> 남기실 말</label> <input type="text" id="matching_comment" name="comment"
               required>
      ...
      <section>
         ...
         <form>
            ...
            <label for="playerName">팀 이름</label> <input type="text" id="M_playerName" name="playerName" required>
            <label for="position">가능한 시작 시간 </label> <select id="M_starttime" name="starttime" required>
               <option value="미정">미정</option>
               <option value="00:00">00:00</option>
               <option value="01:00">01:00</option>
               <option value="02:00">02:00</option>
               ...
               <option value="22:00">22:00</option>
               <option value="23:00">23:00</option>
            </select> <label for="position"> 가능한 끝 시간</label> <select id="M_finishtime" name="finishtime">
               <option value="미정">미정</option>
               <option value="00:00">00:00</option>
               <option value="01:00">01:00</option>
               <option value="02:00">02:00</option>
            ...
            </select> <label for="position"> 원하는 인원수 </label> <select id="M_peoplenum" name="peoplenum">
               ...
               <option value="6명">6명</option>
               <option value="그 외">그 외</option>
            </select> <label for="position"> 남기실 말</label> <input type="text" id="M_comment" name="comment"
               required>
   ...
   <script>
      ...
      function matchingRegistration() {
         ...
         document.getElementById('bulletinList').appendChild(listItem)
